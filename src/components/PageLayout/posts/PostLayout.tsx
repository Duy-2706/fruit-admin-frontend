      ...
      <div className="flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            <input
              type="text"
              placeholder="Tìm kiếm theo tiêu đề, slug, danh mục, tác giả..."
              value={searchQuery}
...
export function PostTable({ posts, loading, onEdit, onDelete }: PostTableProps) {
  const columns = [
    { key: 'id', label: 'ID', width: '60px', sortable: true, className: 'text-center' },
    { key: 'title', label: 'TIÊU ĐỀ', sortable: true, className: 'text-left font-medium', width: '200px' },
    { key: 'slug', label: 'SLUG', width: '200px', sortable: true, className: 'text-center' },
    { key: 'category_name', label: 'DANH MỤC', width: '150px', sortable: true, className: 'text-center' },
    { key: 'author_name', label: 'TÁC GIẢ', width: '150px', sortable: true, className: 'text-center' },
    {
      key: 'actions',
      label: 'THAO TÁC',
      width: '120px',
      sortable: false,
      render: (_value: any, row: Post) => (
