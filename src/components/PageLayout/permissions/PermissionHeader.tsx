  ...
  return (
    <div className="p-5 border-b border-gray-200 bg-white">
      <div className="flex items-center justify-between gap-6">
        {/* Left: Title */}
        <div>
          <h2 className="text-lg font-semibold text-gray-900">Danh sách quyền</h2>
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            <input
              type="text"
              placeholder="Tìm kiếm theo tên, mã, slug..."
              value={searchQuery}
...
export function PermissionTable({ permissions, loading, onEdit, onDelete }: PermissionTableProps) {
  const columns = [
    { 
      key: 'id', 
      label: 'ID', 
